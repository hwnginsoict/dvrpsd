...
class INFER_V4:
            ...
            # if True:
                ...
                for m in range(self.max_iteration_dynamic): 
                    ...
                    for ants in range(self.num_ants_dynamic):
                        ...
                        pointer = 0
                        remain_capacity = self.max_capacity - sum(i.demand for i in solution[0])
                        visited = set()
                        ...
                        # self.update_pheromone([solution]) # test bug
    ...
    def dyn_generate_probability(self, current_node, candidate_list, visited, remain_capacity, solution_time, timetime):
        ...
        for request in candidate_list: 
            if request.node not in visited:
                ...
                total += (pheromone)**self.alpha * (1/waiting)**self.beta * (1/td_diff)
    ...
    # def calculate_solution_distance_own(self, solution):
    ...
    def print_route_normal(self, route):
